...
const resources = {
  en: {
    translation: {
      ...
      Successpaymentmessage: "Your payment is complete. Now you can log in to the Panchal Samaj app to get started.",
      Failpaymentmessage: "You may have cancelled the payment or there was a delay in response from the UPI app.",
  ...
  gu: {
    translation: {
      ...
      PleaseEnterEmail: "કૃપા કરીને ઇમેઇલ દાખલ કરો",
      Successpaymentmessage: "તમારી ચુકવણી પૂરી થઈ છે. હવે તમે પંચાલ સમાજ એપ માં લોગ ઇન કરી શરૂ કરી શકો છો.",
      Failpaymentmessage: "તમે પેમેન્ટ કેન્સલ કર્યું હશે અથવા UPI એપ તરફથી જવાબ આપવામાં વિલંબ થયો હશે",
      TotalAmount: "કુલ રકમ",
      MemberId: "સભ્ય આઈડી",
      StartDate: "શરૂ તારીખ",
